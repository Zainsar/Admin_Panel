...
if (isset($_POST["Register"])) {
  ...
  $email_check = "select * from temps where Email = '$email'";
  $result = mysqli_query($conn, $email_check);
  if (mysqli_num_rows($result) > 0) {
    echo "<script> alert('Email already exist'); </script>";
  } else {
    $insert_query = "INSERT INTO `temps` (`Username`, `Email`, `Password`) VALUES ('$username', '$email', '$password')";
            ...
            <div class="row align-items-end">
              ...
              <div class="col-md-12">
                <div class="form-group mt-4">
                  <div class="radio">
                    <button class="btn btn-primary py-3 px-4" name="Register">Register</button>
                  </div>
                </div>
              </div>
